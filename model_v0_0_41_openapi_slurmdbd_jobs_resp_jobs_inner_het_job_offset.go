...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset Unique sequence number applied to this component of the heterogeneous job
type V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset() *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset(val *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset) UnmarshalJSON(src []byte) error {
	v.isSet = true
