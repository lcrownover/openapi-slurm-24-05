...
type V0041OpenapiJobInfoRespJobsInner struct {
	...
	ArrayTaskId *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"array_task_id,omitempty"`
	...
	DerivedExitCode *V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCode `json:"derived_exit_code,omitempty"`
	...
	HetJobOffset *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset `json:"het_job_offset,omitempty"`
	// Job ID
	...
	MemoryPerNode *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode `json:"memory_per_node,omitempty"`
...
// SetArrayTaskId gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the ArrayTaskId field.
...
func (o *V0041OpenapiJobInfoRespJobsInner) GetDerivedExitCode() V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCode {
	if o == nil || IsNil(o.DerivedExitCode) {
		var ret V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCode
		return ret
	}
...
// SetDerivedExitCode gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCode and assigns it to the DerivedExitCode field.
...
func (o *V0041OpenapiJobInfoRespJobsInner) GetHetJobOffset() V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset {
	if o == nil || IsNil(o.HetJobOffset) {
		var ret V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset
		return ret
	}
...
// SetHetJobOffset gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset and assigns it to the HetJobOffset field.
...
func (o *V0041OpenapiJobInfoRespJobsInner) GetMemoryPerNode() V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode {
	if o == nil || IsNil(o.MemoryPerNode) {
		var ret V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode
		return ret
	}
...
// SetMemoryPerNode gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode and assigns it to the MemoryPerNode field.
