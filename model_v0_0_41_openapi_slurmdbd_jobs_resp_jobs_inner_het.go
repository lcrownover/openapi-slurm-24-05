...
type V0041OpenapiSlurmdbdJobsRespJobsInnerHet struct {
	...
	JobOffset *V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset `json:"job_offset,omitempty"`
}
...
// SetJobOffset gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerHetJobOffset and assigns it to the JobOffset field.
