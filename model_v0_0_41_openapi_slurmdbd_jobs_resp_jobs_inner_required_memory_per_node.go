...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode Minimum memory in megabytes per allocated node
type V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode() *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode(val *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
