...
type V0041OpenapiSlurmdbdJobsRespJobsInnerArray struct {
	...
	TaskId *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"task_id,omitempty"`
...
// SetTaskId gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the TaskId field.
